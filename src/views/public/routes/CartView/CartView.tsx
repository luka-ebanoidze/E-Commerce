    ...
    <div className="mt-20">
      <div className="h-[200px] flex justify-around items-center max-sm:flex-col max-sm:gap-10">
        <div className="flex flex-col gap-10">
          <h1 className="px-5 py-2 rounded-full bg-white border-solid border-[4px] border-gray-600">
        ...
        <div className="px-8 hover:cursor-pointer py-2 rounded-full bg-white border-solid border-[4px] border-gray-600">
          {status === "authorized" ? (
      ...
      <div className="flex flex-col gap-10 py-5">
        {items.map((item: any) => (
          ...
          >
            ...
            <div className="flex w-[300px] h-[100px] justify-between flex-col max-sm:w-[150px]">
              ...
              <button
                className="border-solid font-bold border-[3px] py-2 hover:cursor-pointer rounded-full bg-gray-200 border-gray-600"
        ...
        <button
          className="border-solid border-[4px] hover:cursor-pointer font-bold py-2 rounded-full bg-white border-gray-600"
          onClick={() => {
            emptyCart();
          }}
        >
